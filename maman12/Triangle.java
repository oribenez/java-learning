...
public class Triangle {
    ...
    /**
     * Constructor that create Triangle object using six numbers that each pair of arguments represents 
     * the Triangle vertex. If the values of the Triangle vertices are invalid the method sets the Triangle vertices to it's default values.
    ...
    /**
     * Method which sets the first point of this triangle only if it is valid after change.
    ...
    /**
     * Method which sets the second point of this triangle only if it is valid after change.
     * @param p the desired point to change to.
     */
    ...
    /**
     * Method which sets the third point of this triangle only if it is valid after change.
     * @param p the desired point to change to.
     */
     ...
     * @return true if all three points can behave like a triangle vertices, otherwise false.
     */
    public boolean isValid(Point p1, Point p2, Point p3){
        //Measeure three sides of the triangle
    ...
    public boolean isPythagorean() {
        ...
        return epsilonEqual(a*a + b*b,c*c) || epsilonEqual(a*a + c*c,b*b) || epsilonEqual(b*b + c*c,a*a);
    }
    ...
    /**
     * Method which checks if the whole triangle is located in one quadratant.
     * @return True if the whole triangle is located in one quadratant, otherwise false.
     */
     ...
     * @return True if this triangle is above the given argument triangle, otherwise false.
     */
    ...
    /**
     * Method checks if this triangle points are equals to the given argument triangle 
     * corresponding to each point.
     * @param other the triangle to compare to.
     * @return True if both triangles points equals to the given triangle points in the correct order.
     */
